...
function u(){}
function ga(a){a.na=void 0;a.getInstance=function(){return a.na?a.na:a.na=new a}}
...
;if(Wb&&!Na()){var $b="."+qa.domain;try{for(;2<$b.split(".").length&&!Na();)qa.domain=$b=$b.substr($b.indexOf(".")+1),Oa=window.parent}catch(a){}Na()||(Oa=window)}var ac=Oa,bc=new Zb(1,ac);function cc(){ac.google_measure_js_timing||(bc.g&&C(bc.events,bc.i,bc),bc.events.length=0,bc.b=!1)}
if("complete"==ac.document.readyState)cc();else if(bc.b){var dc=function(){cc()};
ac.addEventListener?ac.addEventListener("load",dc,Pa?void 0:!1):ac.attachEvent&&ac.attachEvent("onload",dc)};var ec=(new Date).getTime();function fc(a){if(!a)return"";a=a.split("#")[0].split("?")[0];a=a.toLowerCase();0==a.indexOf("//")&&(a=window.location.protocol+a);/^[\w\-]*:\/\//.test(a)||(a=window.location.href);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");-1!=c&&(b=b.substring(0,c));a=a.substring(0,a.indexOf("://"));if("http"!==a&&"https"!==a&&"chrome-extension"!==a&&"file"!==a&&"android-app"!==a&&"chrome-search"!==a)throw Error("Invalid URI scheme in origin");var c="",d=b.indexOf(":");if(-1!=d){var e=b.substring(d+
...
a=Oc(a);Hc.test(c)||M("invalid_callback");b=Pc(b);d=d&&d.length?Pc(d):null;return[encodeURIComponent(a.Za).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.ra?"/am="+e(a.ra):"",a.za?"/rs="+e(a.za):"",a.Ca?"/t="+e(a.Ca):"","/cb=",e(c)].join("")}
...
var G=Uc(a,N);if(G.length){var G=Uc(a,k),ea=J(L,"CP",[]),fa=ea.length;ea[fa]=function(a){function b(){var a=ea[fa+1];a&&a()}
function c(b){ea[fa]=null;d(G,a)&&pc(function(){e&&e();b()})}
if(!a)return 0;Ac("ml1",G,ta);0<fa&&ea[fa-1]?ea[fa]=function(){c(b)}:c(b)};
if(G.length){var vc="loaded_"+L.I++;nc[vc]=function(a){ea[fa](a);nc[vc]=null};
a=Jc(c,G,"gapi."+vc,k);k.push.apply(k,G);Ac("ml0",G,ta);b.sync||gc.___gapisync?Wc(a):Xc(a)}else ea[fa](jc)}else d(G)&&e&&e()}
...
function Ze(a,b){var c=T("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.qb&&(!Sb(I(a)[3]||null)||b.withCredentials||Sb(I(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.F&&b.F[c])}
function $e(a,b){var c=b.format||"JSON";b.La&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=T("XSRF_FIELD_NAME",void 0),e=T("XSRF_TOKEN",void 0),f=b.kb;f&&(f[d]&&delete f[d],a=Ve(a,f||{}));var g=b.postBody||"",f=b.F;Ze(a,b)&&(f||(f={}),f[d]=e);f&&q(g)&&(d=Ue(g),Ja(d,f),g=b.xa&&"JSON"==b.xa?JSON.stringify(d):We(d));var h=!1,k,m=af(a,function(a){if(!h){h=!0;k&&window.clearTimeout(k);var d=Te(a),e=null;if(d||400<=a.status&&
...
f}catch(D){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(nf[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=a.fileName;b={kb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},F:{url:T("PAGE_NAME",
...
ga(Eg);function Fg(a,b,c,d){b="string"==typeof b?b.split("."):[b,c,d];b[0]=parseInt(b[0],10)||0;b[1]=parseInt(b[1],10)||0;b[2]=parseInt(b[2],10)||0;return a.b>b[0]||a.b==b[0]&&a.f>b[1]||a.b==b[0]&&a.f==b[1]&&a.g>=b[2]}
...
;function Dh(a,b){O.call(this);this.B=this.l=a;this.U=b;this.D=!1;this.g={};this.aa=this.T=null;this.V=new Q;qd(this,w(rd,this.V));this.j={};this.L=this.ba=this.i=this.ia=this.b=null;this.X=!1;this.M=this.C=this.w=this.R=null;this.ca={};this.Da=["onReady"];this.Y=new Wg(this);qd(this,w(rd,this.Y));this.ga=null;this.pa=NaN;this.Z={};Eh(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Fa,this));this.G("onTabAnnounce",v(this.qa,this));this.G("WATCH_LATER_VIDEO_ADDED",v(this.Ua,
this));this.G("WATCH_LATER_VIDEO_REMOVED",v(this.Va,this));sb||(this.G("onMouseWheelCapture",v(this.Ra,this)),this.G("onMouseWheelRelease",v(this.Sa,this)));this.G("onAdAnnounce",v(this.qa,this));this.N=new Wg(this);qd(this,w(rd,this.N));this.ha=!1;this.fa=null}
...
function Kh(a){var b=a.b&&a.b.args&&a.b.args.fflags;if(b&&0<=b.indexOf("web_player_disable_flash=true"))return!1;if(!p(a.b.disable.flash)){var b=a.b.disable;var c=Fg(Eg.getInstance(),a.b.minVersion);b.flash=!c}return!a.b.disable.flash}
...
a.b.disable.html5=!d;d||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?Kh(a)?"flash":"unsupported":"html5"}("flash"==b?a.lb:a.mb).call(a)}}
function Nh(a){var b=!0,c=Mh(a);c&&a.b&&(a=a.b,b=re(c,"version")==a.assets.js);return b&&!!t("yt.player.Application.create")}
l.mb=function(){if(!this.X){var a=Nh(this);if(a&&"html5"==Oh(this))this.L="html5",this.D||this.P();else if(Ph(this),this.L="html5",a&&this.w)this.l.appendChild(this.w),this.P();else{this.b.loaded=!0;var b=!1;this.R=v(function(){b=!0;var a=this.l,d=Dg(this.b);t("yt.player.Application.create")(a,d);this.P()},this);
...
l.bb=function(a,b){if(!this.f){var c=Jh(this,b);c&&Zd(this.V,a,c)}};
...
l.Ta=function(a){Lh(this,a)};
l.Ua=function(a){Be("WATCH_LATER_VIDEO_ADDED",a)};
l.Va=function(a){Be("WATCH_LATER_VIDEO_REMOVED",a)};
l.Ra=function(){if(!this.ha){if(wb){var a=document,b=a.scrollingElement?a.scrollingElement:cb||"CSS1Compat"!=a.compatMode?a.body||a.documentElement:a.documentElement,a=a.parentWindow||a.defaultView;this.fa=$a&&pb("10")&&a.pageYOffset!=b.scrollTop?new Ba(b.scrollLeft,b.scrollTop):new Ba(a.pageXOffset||b.scrollLeft,a.pageYOffset||b.scrollTop);Xg(this.N,window,"scroll",this.Ya);Xg(this.N,this.l,"touchmove",this.Xa)}else Xg(this.N,this.l,"mousewheel",this.va),Xg(this.N,this.l,"wheel",this.va);this.ha=
!0}};
l.Sa=function(){Yg(this.N);this.ha=!1};
...
l.eb=function(a,b){this.j&&!this.f&&ci(this.g,a,this.ja(a,b))};
...
aa(ii,hi);function ji(){var a=!!T("WIDGET_ID_ENFORCE"),a=this.f=new ii(a),b=v(this.ab,this);a.j=b;a.l=null;this.f.channel="widget";if(a=T("WIDGET_ID"))this.f.sessionId=a;this.i=[];this.l=!1;this.j={}}
l=ji.prototype;l.ab=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.j[c]||"onReady"==c||(this.addEventListener(c,ki(this,c)),this.j[c]=!0)}else this.Ba(a,b)};
l.Ba=function(){};
...
l.fb=function(a){li(this,{playbackQuality:a})};
l.gb=function(a){li(this,{playbackRate:a})};
...
l.jb=function(){li(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.ib=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:x()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());li(this,a)};
...
aa(si,B);function ti(a){B.call(this,a.message||a.description||a.name);this.b=a instanceof Pd}
...
return wi}
function yi(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ui;a=JSON.parse(a.substr(4));if((T("EXP_HTML5_SERVERSIDE_IGNORE_BISCOTTI_ID_ON_RETRY",!1)||V("html5_serverside_ignore_biscotti_id_on_retry"))&&1<(a.type||1))throw new ui;a=a.id;Ai(a);wi=new vi(a);Bi(18E5,2);return a}
...
ga(Gi);var Z=t("yt.prefs.UserPrefs.prefs_")||{};r("yt.prefs.UserPrefs.prefs_",Z,void 0);function Hi(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
...
r("writeEmbed",function(){var a=T("PLAYER_CONFIG",void 0);"1"!=a.privembed&&Di(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=T("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);T("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&$h(a.args);Ki=a=Vh(a);a.addEventListener("onScreenChanged",Qi);a.addEventListener("onLogClientVeCreated",Pi);a.addEventListener("onLogServerVeCreated",Ri);a.addEventListener("onLogToGel",
