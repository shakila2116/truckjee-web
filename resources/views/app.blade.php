...
<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
    ...
    *************************************-->
    <header id="tg-header" class="tg-header tg-haslayout">
        {{--<div class="tg-topbar tg-haslayout" style="background: #399">--}}
            {{--<div class="container">--}}
                {{--<div class="row">--}}
                    {{--<div class="col-sm-12 col-xs-12">--}}
                        {{--<ul class="tg-addressinfo">--}}
                            {{--<li>--}}
                                {{--<figure>--}}
                                    {{--<a href="javascript:void(0);"><img src="images/logo1.png" alt="image description " width="221px" style="margin: -30px 41px -4px -102px;"></a>--}}
                                {{--</figure>--}}
                            {{--</li>--}}
                            {{--<li>--}}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <strong class="tg-logo"><img src="images/logof.png" alt="image description" width="155px" style="margin-top: 6px;"></strong>
