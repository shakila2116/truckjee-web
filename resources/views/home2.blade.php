...
@section('content')
    ...
    <div class="tg-homebannerandslider">
        <div class="container-fluid">
            <div class="row">
                                        ...
                                        <div class="tg-panel">
                                            <div class="tg-accordionheading tg-automotive tg-radio">
                                                ...
                                                <label for="tg-radioautomotive">
                                                    <span class="fa fa-truck tg-categoryicon" style="background: mediumaquamarine"></span>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <figure class="tg-featuredimg" style="width: 73%;">
    ...
    {{--</div>--}}
    {{--<div class="item">--}}
    {{--<figure><img src="images/testimonials/img-03.jpg" alt="image description"></figure>--}}
    {{--</div>--}}
    {{--<div class="item">--}}
    {{--<figure><img src="images/testimonials/img-04.jpg" alt="image description"></figure>--}}
    {{--</div>--}}
    {{--<div class="item">--}}
    {{--<figure><img src="images/testimonials/img-05.jpg" alt="image description"></figure>--}}
    {{--</div>--}}
    {{--<div class="item">--}}
    {{--<figure><img src="images/testimonials/img-06.jpg" alt="image description"></figure>--}}
    {{--</div>--}}
    {{--<div class="item">--}}
    {{--<figure><img src="images/testimonials/img-07.jpg" alt="image description"></figure>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <figure class="tg-noticeboard"><img src="images/noticeboard.png" alt="image description"></figure>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="tg-newsandposts">
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <article class="tg-post">
                                <figure class="tg-featuredimg">
                                    <a href="javascript:void(0);"><img src="images/news/img1.jpg" alt="image description"></a>
                                </figure>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <article class="tg-post">
                                <figure class="tg-featuredimg">
                                    <a href="javascript:void(0);"><img src="images/news/img2.jpg" alt="image description"></a>
                                </figure>
                                <div class="tg-postcontent">
                                    <div class="tg-title">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <article class="tg-post">
                                <figure class="tg-featuredimg">
                                    <a href="javascript:void(0);"><img src="images/news/img3.jpg" alt="image description"></a>
                                </figure>
                                <div class="tg-postcontent">
                                    <div class="tg-title">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                            <article class="tg-post">
                                <figure class="tg-featuredimg">
                                    <a href="javascript:void(0);"><img src="images/news/img5.png" alt="image description"></a>
                                </figure>
                                <div class="tg-postcontent">
                                    <div class="tg-title">
